...
#region Basic Types IO
    ...
    public static List<double> FromDoubleArrayBufferToList(byte[] buffer) =>
        new List<double>(FromDoubleArrayBuffer(buffer));
    public static List<int> FromIntArrayBufferToList(byte[] buffer) =>
        new List<int>(FromIntArrayBuffer(buffer));
