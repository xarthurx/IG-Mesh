...
namespace GSP
{
    public static class NativeBridge
    {
        ...
        private static extern bool GetMeshWin(byte[] inBuffer, int inSize, out IntPtr outBuffer, out int outSize);
        [DllImport(MacLibName, EntryPoint = "get_mesh", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetMeshMac(byte[] inBuffer, int inSize, out IntPtr outBuffer, out int outSize);
