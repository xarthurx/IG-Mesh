...
namespace igmGH
{
    public class IGM_random_points_on_mesh : GH_Component
    {
        ...
        public override void AppendAdditionalMenuItems(System.Windows.Forms.ToolStripDropDown menu)
        {
            ...
            Menu_AppendItem(menu, " Random", (sender, e) => Helper.SelectMode(this, sender, e, ref mode, "random"), true, CheckMode("random"));
            Menu_AppendItem(menu, " Uniform", (sender, e) => Helper.SelectMode(this, sender, e, ref mode, "uniform"), true, CheckMode("uniform"));
        }
