...
namespace igmGH {
  public class igmInfo : GH_AssemblyInfo {
    ...
    public override string Description =>
        "IG-Mesh is a one-stop solution for low-level (vertex-based, edge-based) mesh processing, featuring many advanced algorithms from computer graphics community.";
