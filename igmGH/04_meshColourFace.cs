...
namespace igmGH
{
    public class IGM_mapColorFace : GH_Component
    {
        ...
        public IGM_mapColorFace()
          : base("Mesh Colours ~ Face", "igMeshColourFace",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetDataList<System.Drawing.Color>(1, FC)) { return; }

            if (FC.Count != mesh.Faces.Count)
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Face number and color number does not match.");
            }
        ...
        {
            args.Display.DrawMeshShaded(renderMesh, new Rhino.Display.DisplayMaterial(System.Drawing.Color.Black));
